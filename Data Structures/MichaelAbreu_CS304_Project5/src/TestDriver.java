...
public class TestDriver {
	...
	public static void main(String[] args) throws QueueUnderflowException {
		...
		while (keepGoing) {
			...
			System.out.println("3: contains (string)");
			System.out.println("4: remove (string)");
			System.out.println("5: get (string)");
			System.out.println("6: add (string)");
			System.out.println("7: print (traversal order)");
			...
			case 3: // contains
				...
				System.out.println("contains(" + target + ") returns "
			...
			case 4: // remove
				...
				target = conIn.nextLine();
				System.out.println("remove(" + target + ") returns "
						+ tree.remove(target));
				break;
			...
			case 5: // get
				...
				target = conIn.nextLine();
				System.out.println("get(" + target + ") returns "
						+ tree.get(target));
				break;
			...
			case 7: // print tree
				...
				case 1:
					...
					for (int count = 1; count <= treeSize; count++) {
						element = (String) tree
								.getNext(BinarySearchTree.PREORDER);
				...
				case 2:
					...
					for (int count = 1; count <= treeSize; count++) {
						element = (String) tree
								.getNext(BinarySearchTree.INORDER);
						System.out.println(element);
					}
					break;
			...
			default:
				System.out
						.println("Error in operation choice. Terminating test.");
				return;
			}
		}
